...
/** 
 Round 1A 2016  https://code.google.com/codejam/contest/4304486/dashboard#s=p0
...
public class LastWord {
	public static void main(String[] args) throws IOException {
		...
		while ((line = br.readLine()) != null && totalCases >= caseNo) {
			bw.write("Case #"+caseNo+": "+getLastWord(line));
			bw.newLine();
			caseNo++;
		}
	...
	private static String getLastWord(String line) {
		...
		for(int i=0; i< length; i++){
			String currStr = line.substring(i,i+1);
			if(firstChar == null || firstChar.compareTo(currStr) <= 0){
				firstChar = currStr;
				str = currStr + str;
			}else{
				str = str + currStr;
